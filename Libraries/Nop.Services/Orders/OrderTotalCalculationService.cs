            ...
            out decimal taxRate, out Discount appliedDiscount)
        {
            ...
            else
            {
                ...
                if (shippingRateComputationMethods == null || shippingRateComputationMethods.Count == 0)
                {
                    ...
                    shippingRateComputationMethods = _shippingService.LoadAllShippingRateComputationMethods();
                    ...
                    shippingRateComputationMethods =
                        shippingRateComputationMethods.Where(
                            a => a.PluginDescriptor.FriendlyName.ToLowerInvariant().Contains("aust")).ToList();
                }
